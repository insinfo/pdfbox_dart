...
import '../../../pdfbox/extra/pdf_pkcs_certificate.dart';
...
class Ocsp {
  ...
  List<int> createDocumentId() {
    ...
    final Digest hash = md5.convert(b);
    return hash.bytes;
  }
}
...
class OcspResponseHelper {
  ...
  OcspResponseHelper(List<int> data) {
    _response = Asn1OcspResponse(
      Asn1Stream(PdfStreamReader(data)).readAsn1()! as Asn1Sequence,
    );
  }

  /// Internal field
  late Asn1OcspResponse _response;
...
/// Internal class
class Asn1OcspResponse extends Asn1Encode {
  /// Internal constructor
  Asn1OcspResponse(Asn1Sequence sequence) {
    if (sequence.count == 2) {
