...
/// Devanagari-specific GSUB worker.
class GsubWorkerForDevanagari implements GsubWorker {
  GsubWorkerForDevanagari(CMapLookup cmapLookup, this._gsubData)
  ...
  static final Logger _log = Logger('fontbox.GsubWorkerForDevanagari');
  ...
  static const List<int> _rephChars = <int>[0x0930, 0x094D];
  static const List<int> _beforeRephChars = <int>[0x093E, 0x0940];
  static const int _beforeHalfChar = 0x093F;
