...
class MacExpertEncoding extends Encoding {
  MacExpertEncoding._() {
    for (final entry in _macExpertEncodingTable) {
      addCharacterEncoding(_oct(entry[0]), entry[1]);
    }
  }

  static final MacExpertEncoding instance = MacExpertEncoding._();
}

const List<List<String>> _macExpertEncodingTable = <List<String>>[
  ['0276', 'AEsmall'],
  ['0207', 'Aacutesmall'],
