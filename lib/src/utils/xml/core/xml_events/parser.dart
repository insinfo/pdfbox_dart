import '../../../petitparser/export.dart';
...
class XmlEventParser {
  ...
  Parser<XmlStartElementEvent> startElement() =>
      seq5(
        ...
        (start, nameToken, attributes, space, closeElement) => XmlStartElementEvent(
          nameToken,
          attributes,
  ...
  Parser<XmlEventAttribute> attribute() =>
      seq3(ref0(space), ref0(nameToken), ref0(attributeAssignment)).map3(
        (s, name, attribute) => XmlEventAttribute(
          name,
  ...
  Parser<(String, XmlAttributeType)> attributeAssignment() =>
      seq4(
        ...
        ref0(spaceOptional),
        ref0(attributeValue),
      ).map4((s1, eq, s2, value) => value).optionalWith(const (
        '',
  ...
  Parser<(String, XmlAttributeType)> attributeValueDoubleQuote() => seq3(
    ...
    XmlToken.doubleQuote.toParser(),
  ).map3((q1, value, q2) => (value, XmlAttributeType.DOUBLE_QUOTE));
  ...
  Parser<(String, XmlAttributeType)> attributeValueSingleQuote() => seq3(
    ...
    XmlToken.singleQuote.toParser(),
  ).map3((q1, value, q2) => (value, XmlAttributeType.SINGLE_QUOTE));
  ...
  Parser<XmlEndElementEvent> endElement() => seq4(
    ...
    ref0(spaceOptional),
    XmlToken.closeElement.toParser(),
  ).map4((open, name, space, close) => XmlEndElementEvent(name));
  ...
  ).map3((open, text, close) => XmlCommentEvent(text));
  ...
  ).map3((open, text, close) => XmlCDATAEvent(text));
  ...
  ).map4((open, attributes, space, close) => XmlDeclarationEvent(attributes));
  ...
  ).map4((open, target, text, close) => XmlProcessingEvent(target, text));
  ...
  Parser<XmlDoctypeEvent> doctype() =>
      seq8(
        ...
        (open, space1, name, externalId, space2, internalSubset, space3, close) =>
  ...
  Parser<DtdExternalId> doctypeExternalIdSystem() => seq3(
    ...
    ref0(space),
    ref0(attributeValue),
  ).map3((sys, space, attribute) => DtdExternalId.system(attribute.$1, attribute.$2));
  ...
  Parser<DtdExternalId> doctypeExternalIdPublic() =>
      seq5(
        ...
        (pub, space1, publicAttribute, space2, systemAttribute) => DtdExternalId.public(
          publicAttribute.$1,
          publicAttribute.$2,
          systemAttribute.$1,
          systemAttribute.$2,
  ...
  ).map3((open, contents, close) => contents);
