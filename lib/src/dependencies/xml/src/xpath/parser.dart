...
import '../../../petitparser/definition.dart';
import '../../../petitparser/parser.dart';
...
class XPathParser {
  ...
  Parser<XPathExpression> ifExpr() =>
      seq6(
        ...
        (t1, cond, t2, trueExpr, t3, falseExpr) =>
  ...
  Parser<NodeTest> wildcard() => [
    ...
    seq3(
      ...
      token(':'),
      ref0(ncName),
    ).map3((t1, t2, name) => LocalNameNodeTest(name)),
    // braccedURILiteral*
    seq2(
    ...
    seq3(
      ...
      token(':'),
      token('*'),
    ).map3((prefix, t1, t2) => NamespacePrefixNameNodeTest(prefix)),
  ...
  Parser<XPathExpression> mapConstructor() => seq4(
    ...
    token('}'),
  ).map4((t1, t2, entries, t3) => MapConstructor(entries.elements));
  ...
  Parser<NodeTest> schemaAttributeTest() => seq4(
    ...
    token(')'),
  ).map4((t1, t2, arg, t3) => _unimplemented('SchemaAttributeTest'));
  ...
  Parser<NodeTest> schemaElementTest() => seq4(
    ...
    token(')'),
  ).map4((t1, t2, arg, t3) => _unimplemented('SchemaElementTest'));
