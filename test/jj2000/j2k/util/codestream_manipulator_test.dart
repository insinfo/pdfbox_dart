...
import 'package:pdfbox_dart/src/jj2000/j2k/util/codestream_manipulator.dart';
    ...
    test('splits tile-part when packet budget exceeded', () async {
      ...
      try {
        final file = File('${tempDir.path}/two_packets.j2k')
          ..writeAsBytesSync(_codestreamWithTwoPackets);
        final manipulator = CodestreamManipulator(
          file.path,
          1,
          1,
    ...
    test('interleaves tile-parts across multiple tiles', () async {
      ...
      try {
        final file = File('${tempDir.path}/multi_tile.j2k')
          ..writeAsBytesSync(_codestreamAcrossTwoTiles);
        final manipulator = CodestreamManipulator(
          file.path,
          2,
          1,
...
final List<int> _codestreamWithTwoPackets = List<int>.unmodifiable(<int>[
  0xFF,
  0x4F,
  0xFF,
  0x51,
...
final List<int> _codestreamAcrossTwoTiles = List<int>.unmodifiable(<int>[
  0xFF,
  0x4F,
  0xFF,
  0x51,
