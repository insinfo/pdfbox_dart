...
- `lib/src/fontbox/ttf/open_type_script.dart` e `lib/src/fontbox/ttf/model/language.dart`: mapeamento reduzido a Latin + alguns scripts índicos; Scripts.txt completo e demais idiomas precisam ser incorporados.
