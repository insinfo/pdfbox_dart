...
import 'package:pdfbox_dart/src/dependencies/xml/src/xpath/functions/general.dart';
...
void main() {
  test('op:and', () {
    ...
    expect(
      opAnd(context, [XPathSequence.trueSequence, XPathSequence.trueSequence]),
      [true],
    );
    expect(
      opAnd(context, [XPathSequence.trueSequence, XPathSequence.falseSequence]),
      [false],
    );
    expect(
      opAnd(context, [XPathSequence.falseSequence, XPathSequence.trueSequence]),
      [false],
    );
  });
  test('op:or', () {
    ...
    expect(
      opOr(context, [XPathSequence.falseSequence, XPathSequence.falseSequence]),
      [false],
    );
    expect(
      opOr(context, [XPathSequence.trueSequence, XPathSequence.falseSequence]),
      [true],
    );
    expect(
      opOr(context, [XPathSequence.falseSequence, XPathSequence.trueSequence]),
      [true],
    );
  });
